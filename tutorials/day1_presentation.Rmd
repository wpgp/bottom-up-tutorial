...
# When population data with full coverage is available
...
# When population data with full coverage is **not** available
...
.center[[Chapter 1, Bayes Rules! An Introduction to Bayesian Modeling with R ](https://www.bayesrulesbook.com/chapter-1.html)]
...
we can update the prior information of the weather in September in the UK.
...
More details in [Chapter 2, Bayes Rules! An Introduction to Bayesian Modeling with R ](https://www.bayesrulesbook.com/chapter-2.html)
...
- Impossible to know all relevant predictors
...
2. Evaluate how likely the value is to explain the data given the prior belief
3. Draw another value linked depending on the goodness of the previous value
...
4. [Bayesian Data Analisys course](https://avehtari.github.io/BDA_course_Aalto/), by Aki Vehtari
