...
fit_poisson_lognormal <- stan(
  file= here('tutorials', 'refresher','section2' ,'poisson_lognormal.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = seed,
...
fit_poisson_lognormal_independent <- stan(
  file= here('tutorials', 'refresher','section2','poisson_independent.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = seed,
...
fit_poisson_lognormal_hierarchical_cp <- stan(
  file= here('tutorials', 'refresher','section2','poisson_hierarchical_cp.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = seed,
...
fit_poisson_lognormal_hierarchical_var<- stan(
  file= here('tutorials', 'refresher','section3' ,'poisson_hierarchical_variance.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = seed,
...
fit_poisson_lognormal_hierarchical_nclp <- stan(
  file= here('tutorials', 'refresher','section3','poisson_hierarchical_nclp.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = seed,
...
fit_poisson_lognormal_hierarchical_nclsp <- stan(
  file= here('tutorials', 'refresher','section3','poisson_hierarchical_nclsp.stan'),
  data= input_data,
  iter = iter + warmup,
  warmup = warmup,
  seed = 1095856,
