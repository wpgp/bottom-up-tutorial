...
As shown in previous paragraph, Bayesien estimation highly relies on choosing correct 
...
inacurracy increase. However they still remains in the same range, which seems to indcate
...
Unfortunately we are not allowed to redistribute the settlement map used in Nigera v1.2, that
